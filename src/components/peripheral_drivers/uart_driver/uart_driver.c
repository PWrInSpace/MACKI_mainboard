...
uart_driver_status_t uart_driver_init(uart_driver_config_t *config) {
  ...
  // TODO(Glibus): Replace magic numbers
...
uart_driver_status_t uart_driver_read(uart_driver_config_t *config,
...
uart_driver_status_t uart_driver_write(uart_driver_config_t *config,
                                       uint8_t *data, size_t size) {
